package test.testbed.region;
	...
	public class AdaptationOverheadChart extends ApplicationFrame {

		public final JFreeChart chart;
		
		/**
		 * 1-services-1-CP-4575
		 * 1-services-3-CP-10852
		 * 2-services-14498
		 * 4-services-25836
		 * 6-services-37648
		 * 8-services-47085
		 * 3-service-with-1-has-3-CP 18356  16256
		 */
		private static double[] R = {14768, 25992, 13806, 13979};
		private static double[] C = {14498, 25836, 37648, 47085}; 
		private static double[] FD1 = {10733, 10852, 10612, 10776};
		private static double[] SD = {14811, 25322, 20167, 18277};
		private static double[] FD = {14411, 14322, 14195, 14711};
		public AdaptationOverheadChart(String title) {
			super(title);
		...
		private JFreeChart createChart(final XYDataset dataset) {
			...
			final JFreeChart chart = ChartFactory.createXYLineChart(
					...
					"", // domain
																		// axis
																		// label
					"Overhead (s)",//"Reliability (%)",//"Throughput (req/min)",//"Response Time (ms)",//"Average time (ms) taken for each service to complete", // range
																			// axis
																			// label
					dataset, // data
		  ...
		  */
			...
			XYTitleAnnotation ta = new XYTitleAnnotation(0.11, 1.02, lt,
			...
			renderer.setSeriesShape(0, new Rectangle(-5,-5,5,5));
			renderer.setSeriesShape(1, ShapeUtilities.createDiamond(3));
			renderer.setSeriesShape(2, ShapeUtilities.createDiagonalCross(3, 0));
			renderer.setSeriesShape(4, new Ellipse2D.Double(-3, -3, 6, 6));
			renderer.setSeriesShape(3, ShapeUtilities.createUpTriangle(3));
		...
		public static void main(final String[] args) {
			...
			final AdaptationOverheadChart demo = new AdaptationOverheadChart("");
			demo.pack();
