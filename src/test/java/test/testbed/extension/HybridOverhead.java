...
public class HybridOverhead extends ApplicationFrame {
	...
	private static final double[] hybrid = { 0.6528 };

	private static final double[] mr = {

	0.0171 };

	private static final double[] mrmr = { 0.8393 };
	 ...
	 *            the frame title.
	 */
	public HybridOverhead(final String title) {
		super(title);
		final CategoryDataset dataset = createDataset();
		chart = createChart(dataset);
		final ChartPanel chartPanel = new ChartPanel(chart);
		chartPanel.setPreferredSize(new Dimension(400, 150));//180,130
	...
	private CategoryDataset createDataset() {
		...
		final String category1 = "Selection Technique";

		// create the dataset...
		final DefaultCategoryDataset dataset = new DefaultCategoryDataset();

		dataset.addValue(hybrid[0], series1, category1);
		dataset.addValue(mr[0], series2, category1);
		dataset.addValue(mrmr[0], series3, category1);
	...
	private JFreeChart createChart(final CategoryDataset dataset) {
		...
		rangeAxis.setRange(0, 1);// 0.45, 0.8
	...
	public static void main(final String[] args) {
		...
		final HybridOverhead demo = new HybridOverhead(title);
		demo.pack();
